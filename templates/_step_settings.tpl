<div class="admin-yaml-import-form"></div>

<script type="text/html" id="admin-yaml-import-type-dialog-template">
    <div class="modal admin-yaml-import-type-modal">
        <div class="modal-header">
            ...
            <h3>{_ Field: _} <span data-bind="text: nameLabel()"></span></h3>
        </div>
                    ...
                    <div class="span8">
                        ...
                        <!-- ko if: type() === 'medium' -->
                            <label class="checkbox">
                                <input type="checkbox" data-bind="checked: makelist"> {_ Create a list from comma-separated field _}
                            </label>
                        <!-- /ko -->
                        <!-- ko if: type() === 'connection' -->
                            ...
                            <!-- ko if: $root.predicateMapping() !== undefined && categoryOptions().length > 0 -->
                                ...
                                <div class="control-group">
                                    <label class="control-label">{_ Create a list from comma-separated field _}</label>
                                    <div class="controls">
